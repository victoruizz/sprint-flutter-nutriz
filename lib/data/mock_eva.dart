/// Conteudo mockado da EVA: saudacao, chips de sugestao, aviso medico e as
/// respostas mapeadas por palavra-chave a partir dos protocolos/FAQ do produto.
/// Nada aqui chama IA de verdade - e tudo simulado.
...
/// Regra simples de palavra-chave -> resposta. Tudo em minusculas para casar.
class _Regra {
...
const List<_Regra> _regras = [
  ...
  _Regra(
    ['guardar', 'armazenar', 'congelar', 'freezer', 'validade', 'quanto tempo', 'prazo'],
...
/// Resposta mockada da EVA para uma pergunta. Fora do escopo, encaminha.
