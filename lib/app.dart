  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.doacoes: (_) => const HomeShell(abaInicial: 1),
        AppRoutes.pontos: (_) => const HomeShell(abaInicial: 2),
        AppRoutes.conteudo: (_) => const HomeShell(abaInicial: 3),
        AppRoutes.perfil: (_) => const HomeShell(abaInicial: 4),
